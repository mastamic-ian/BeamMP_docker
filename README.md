...
| `-e MaxCars`        | How many vehicles a player is allowed to have at the same time                                 | 1 |
...
| `-e ResourceFolder`         | Which folder your mods are in. Best to leave it at default                                     | `Resources` |
